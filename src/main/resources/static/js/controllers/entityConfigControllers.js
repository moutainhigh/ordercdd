...
app.controller("workflowEntityConfigModuleController",
    [
        ...
        function ($rootScope, $scope, $http, $stateParams) {
            ...
            $scope.openMindPage = function(){
                window.open("tpl/workflowEntityConfigs/mind.html?entity=" + $scope.entity_key,"_blank");
            };
    ...
    [
        ...
        function ($rootScope, $scope, $http, $state, $stateParams, entity) {
            ...
            $scope.save = function () {
                ...
                var noticeRole = "";
                angular.forEach($scope.noticeRole,function (val,key) {
                    noticeRole =  val.id + "-" + noticeRole
                });
                $scope.act.noticeRoles = noticeRole.substring(0,noticeRole.length-1)?noticeRole.substring(0,noticeRole.length-1):null;
