...
//    @PostConstruct
//    public void init() {
//        sdkappid = timKey.getSdkAppId();
//        identifier = timKey.getIdentifier();
//        usersig = timKey.getUserSig();
//        urlTemplate = "https://console.tim.qq.com/" + ver + "/%s/%s?sdkappid=" + sdkappid + "&identifier=" + identifier + "&usersig=" + usersig + "&random=%d&contenttype=json";
//    }
//
