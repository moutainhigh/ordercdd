...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.and()
		.authorizeRequests().antMatchers("/wechat/wlqz/**","/wechat/ddcf/**","/html/**","/js/**","/css/**","/img/**","/images/**","/*.txt","/beidou","/employeeApply","/smsCode","/weblogin","/register","/test","/resetPassword","/beidou/wechatSign","/rest/ordercdds","/rest/departments/search/findByProvinceAndCityAndDistrict","/captcha")
		.permitAll()
		.and()
		.authorizeRequests().antMatchers(HttpMethod.GET,"/rest/*States","/rest/*Acts","/rest/*Workflows","/rest/feetypes","/rest/departmenttypes","/rest/productstorefees","/rest/productcompanyfees","/rest/banks","/rest/punishinterestrules","/rest/feebackups","/rest/roles","/rest/departments","/rest/enterprises","/workflow/**")
		.authenticated()
		.and()
		...
		.and()
		.authorizeRequests().antMatchers("/rest","/rest/*","/rest/*/","/rest/*States","/rest/*Acts","/rest/*Logs","/rest/*Files","/rest/*Workflows","/devUtils/**")
