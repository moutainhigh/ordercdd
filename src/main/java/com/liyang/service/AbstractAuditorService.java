...
//    private TIMService timService;
    @Autowired
    private NoticeService timService;
    ...
    public List<A> findByIdInAndRolesRoleCode(List<Integer> ids, String roleCode) {
        ...
        return getActRepository().findByIdInAndRolesRoleCodeOrderBySortAsc(ids, roleCode);
    }
    ...
    public T doBeforeAct(T entity, A act, Object linked, User fromUser) {
        ...
        try {
            ...
            System.out.println(act.getActCode() + "对应的方法未找到");
    ...
    public List<Tree> workflowTree() {
        ...
        List<S> states = stateRepository.findAll();
    ...
    protected String actIsNotice(A act)
    {
        String noticeType="";
        ...
        if(act.getNoticeOtherTemplate()!=null&&!"".equals(act.getNoticeOtherTemplate())){
            noticeType="其它";
        }else if(act.getNoticeSelfTemplate()!=null&&!"".equals(act.getNoticeSelfTemplate())){
            noticeType="通知自己";
        }else if(act.getNoticeShowTemplate()!=null&&!"".equals(act.getNoticeShowTemplate())){
            noticeType="通知他人";
        }
        return  noticeType;
    }
