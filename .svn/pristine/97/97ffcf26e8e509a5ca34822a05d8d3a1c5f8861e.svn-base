...
//	private static TIMKey timKey;
//
//	@Autowired
//	public void setTimKey(TIMKey timKey) {
//		TIMSignature.timKey = timKey;
//	}
//
//	public static GenTLSSignatureResult generate(String username) {
//		GenTLSSignatureResult result;
//		try {
//			result = GenTLSSignatureEx(timKey.getSdkAppId(), username, timKey.getPriStr());
...
//		try {
//			checkResult = CheckTLSSignatureEx(sig, timKey.getSdkAppId(), username, timKey.getPubStr());
