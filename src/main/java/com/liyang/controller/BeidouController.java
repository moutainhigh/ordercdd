...
//					creditcard.setProduct(productRepository.findFirstByLabel("网点随借随还"));//沈卫说一定是 "网点随借随还"
...
//
////				loan.setDebtorRepaymentDay(CommonUtil.NumToDate((String) getValueFromJson(content, "loanEndDate")));
...
//				loanService.save(loan, (String) getValueFromJson(str, "message"),
//						 getValueFromJson(content, "accountType"));
//				return "index";
//				// 3还款结果通知
...
//				//支付失败
//				if ("1".equals(code)) {
//					wechatPubService.pushRepaymentMessage(orderwdsjsh.getCreatedBy(),
//							orderwdsjsh.getRealName(),
//							"",
//							toMap.get("planCorpus") + "",
//							"还款失败",
...
//				creditrepayment.setDebtorActualRepaymentDate(CommonUtil.NumToDate((String) getValueFromJson(content, "payDate")));// 还款日期
...
//				/*
//				 * if (toMap.get("planCorpus") instanceof Double) { repayment.setPrincipal( new
//				 * BigDecimal((Double) getValueFromJson(list.get(0).toString(),
//				 * "planCorpus")));// 本金 } else { repayment.setPrincipal( new
//				 * BigDecimal((Integer) getValueFromJson(list.get(0).toString(),
//				 * "planCorpus")));// 本金 }
//				 */
