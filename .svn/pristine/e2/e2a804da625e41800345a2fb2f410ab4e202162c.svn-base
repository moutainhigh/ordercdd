            ...
            * */
            this.getUnReadNotice = function(){
                $http.get("/notice/search",{
                    ...
                    if(resResult.content.length){
                        if(resResult.totalPages > 1){
                            $rootScope.unReadNumber = resResult.content.length + "+";
                        }else if(resResult.totalPages === 1){
                            $rootScope.unReadNumber = resResult.content.length
                        }
                    }else{
